# 👋 Hi, I'm Jeshan Chhabra 
### Software Engineering @ McMaster University | AI & Full-Stack Developer

I am a Software Engineering student and former Developer Consultant with a focus on building **scalable systems** and **AI-driven applications**. I specialize in bridging the gap between robust backend architecture and intelligent, context-aware user experiences.
...
| :--- | :--- |
| **Languages** | Java, Python, JavaScript (ES6+), TypeScript, SQL, Bash |
| **AI & Data** | LangChain, RAG Architecture, Vector DBs, PostgreSQL, MongoDB |
| **Frontend** | React, Next.js, Vue.js, Tailwind CSS, SASS |
| **Backend** | Node.js, Express, Spring Boot, FastAPI, .NET Core |
| **Cloud/DevOps** | Azure, Docker, Git, CI/CD Pipelines, Vercel, Linux |
...
[![Portfolio](https://img.shields.io/badge/Live_Project-000000?style=for-the-badge&logo=vercel&logoColor=white)](https://letsmeet-ai.vercel.app/)
[![Email](https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:jeshanchhabra@yahoo.com)

---
*"Building the whole picture, not just the object to be coded."*
